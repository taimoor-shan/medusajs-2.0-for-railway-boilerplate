      ...
      <div className="pt-20 lg:grid lg:grid-cols-12 lg:grid-rows-[auto_auto] lg:gap-x-8 lg:pt-36 max-w-[1440px] mx-auto content-container">
        ...
        <div className="grid grid-cols-1 gap-8 lg:col-span-4 lg:col-start-6 lg:row-span-full mt-12 lg:mt-0">
          <div className="grid grid-cols-2 gap-8 lg:gap-2">
            <div>
              <h3 className="text-lg font-bold text-ui-fg-base mb-4">Shop</h3>
            ...
            <div>
              <h3 className="text-lg font-normal text-ui-fg-base mb-4">Company</h3>
              <ul className="space-y-4">
                {/* <li><LocalizedClientLink className="text-ui-fg-subtle hover:underline underline-offset-4 text-md" href="/policies/privacy">Privacy Policy</LocalizedClientLink></li> */}
                ...
                {/* <li><LocalizedClientLink className="text-ui-fg-subtle hover:underline underline-offset-4 text-md" href="/policies/terms">Terms & Conditions</LocalizedClientLink></li> */}
        ...
        <div className="mt-12 pt-8 lg:pt-0 lg:col-span-5 lg:row-start-2 lg:self-end">
          <ul className="flex space-x-6 items-center mb-8">
            <li>
              <a href="https://facebook.com" target="_blank" rel="noreferrer" className="hover:opacity-75 transition-opacity" aria-label="Facebook">
                <svg viewBox="0 0 11 22" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current text-ui-fg-base h-[24px] w-auto">
            ...
            <li>
              <a href="https://instagram.com" target="_blank" rel="noreferrer" className="hover:opacity-75 transition-opacity" aria-label="Instagram">
                <svg viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current text-ui-fg-base h-[24px] w-auto">
            ...
            <li>
              <a href="https://tiktok.com" target="_blank" rel="noreferrer" className="hover:opacity-75 transition-opacity" aria-label="TikTok">
                <svg viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current text-ui-fg-base h-[24px] w-auto">
            ...
            <li>
              <a href="https://twitter.com" target="_blank" rel="noreferrer" className="hover:opacity-75 transition-opacity" aria-label="Twitter">
                <svg viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current text-ui-fg-base h-[22px] w-auto">
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 text-xs text-ui-fg-muted">
            <p>© {new Date().getFullYear()} {storeName}. All rights reserved.</p>
            <LocalizedClientLink href="/policies/terms" className="hover:text-ui-fg-base transition-colors">Terms and Conditions</LocalizedClientLink>
            <LocalizedClientLink href="/policies/privacy" className="hover:text-ui-fg-base transition-colors">Privacy Policy</LocalizedClientLink>
          </div>
        </div>
      </div>
    </footer>
